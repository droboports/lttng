...
Check the [releases](https://github.com/droboports/lttng/releases) page. If there are no releases available, then you have to compile.
...
```
git clone https://github.com/droboports/lttng.git
cd lttng
./build.sh
ls -la *.tgz
```
...
* libuuid: http://sourceforge.net/projects/e2fsprogs/
